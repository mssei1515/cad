...
test("complete documents normalize to stable v13 unified-canvas data", async ({ page }) => {
...
test("complete v13 documents are byte-shape stable apart from savedAt", async ({ page }) => {
...
test("legacy v1 documents normalize to stable v13 data and reserve new ids", async ({ page }) => {
  await openTestApp(page);
