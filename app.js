...
(function () {
  ...
  const { multiplePropertiesRows, geometryPropertyName, geometryAppearanceSectionName, propertyReadonlyRow, geometryPropertyRows, blockPropertiesConfiguration, blockRotationPropertyRow, dimensionGeometryPropertyRows, constraintDefiningGeometryPropertyRows, annotationAppearancePropertyRows } = window.PropertyRows.create({
  ...
  const { collapsibleSketchAppearanceSection } = propertiesView;
  ...
  function propertiesContent(target) {
